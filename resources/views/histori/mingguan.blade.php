...
<div id="weekSearchButtonContainer" class="mb-4 hidden">  
    <button  
        id="weekSearchButton"  
...
<!-- Device Cards -->  
<div id="weeklyCardsContainer" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4 md:px-0">  
    <!-- Cards will be rendered here -->  
</div>  

<!-- No Data Found -->  
<div id="weeklyNoDataFound" class="hidden">  
